...
#define INIT_OPT_DUMB_PREFIX(prefix, uri) \
	...
	INIT_OPT_DUMB_PREFIX("g", "https://encrypted.google.com/"),
	INIT_OPT_DUMB_PREFIX("gg", "https://encrypted.google.com/"),
	INIT_OPT_DUMB_PREFIX("go", "https://encrypted.google.com/"),
	INIT_OPT_DUMB_PREFIX("fm", "https://freshmeat.net/"),
	INIT_OPT_DUMB_PREFIX("sf", "https://www.sourceforge.net/"),
	INIT_OPT_DUMB_PREFIX("dbug", "https://bugs.debian.org/"),
	INIT_OPT_DUMB_PREFIX("dpkg", "https://packages.debian.org/"),
	...
	INIT_OPT_DUMB_PREFIX("pycur", "https://www.python.org/doc/current/"),
	INIT_OPT_DUMB_PREFIX("pydev", "https://www.python.org/dev/doc/devel/"),
...
#define bugzilla_prefix(prefix) (ELINKS_BUGS_URL prefix)
	...
	INIT_OPT_SMART_PREFIX("g", "https://encrypted.google.com/search?q=%s&btnG=Google+Search"),
	/* Whose idea was it to use 'gg' for websearches? -- Miciah */
	/* INIT_OPT_SMART_PREFIX("gg", "http://groups.google.com/groups?q=%s"), */
	INIT_OPT_SMART_PREFIX("gg", "https://encrypted.google.com/search?q=%s&btnG=Google+Search"),
	INIT_OPT_SMART_PREFIX("gi", "https://images.google.com/images?q=%s"),
	INIT_OPT_SMART_PREFIX("gn", "https://news.google.com/news?q=%s"),
	INIT_OPT_SMART_PREFIX("go", "https://encrypted.google.com/search?q=%s&btnG=Google+Search"),
	INIT_OPT_SMART_PREFIX("gr", "https://groups.google.com/groups?q=%s"),
	INIT_OPT_SMART_PREFIX("google", "https://encrypted.google.com/search?q=%s"),
	...
	INIT_OPT_SMART_PREFIX("dpkg", "https://packages.debian.org/%s"),
	...
	INIT_OPT_SMART_PREFIX("wp", "https://en.wikipedia.org/w/wiki.phtml?search=%s"),
